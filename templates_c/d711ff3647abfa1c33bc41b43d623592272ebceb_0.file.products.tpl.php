<?php
/* Smarty version 3.1.36, created on 2023-10-06 17:08:44
  from '/var/www/panel.hostnate.com/templates/orderforms/pure_comparison/products.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array(
    'version' => '3.1.36',
    'unifunc' => 'content_6520856c70d6a8_13063970',
    'has_nocache_code' => false,
    'file_dependency' =>
    array(
        'd711ff3647abfa1c33bc41b43d623592272ebceb' =>
        array(
            0 => '/var/www/panel.hostnate.com/templates/orderforms/pure_comparison/products.tpl',
            1 => 1696537052,
            2 => 'file',
        ),
    ),
    ...
    function content_6520856c70d6a8_13063970(Smarty_Internal_Template $_smarty_tpl)
    {
                                                ...
                                                <?php if ($_smarty_tpl->tpl_vars['product']->value['isFeatured']) { ?>
                                                    <div class="popular-plan">
                                                        <div class="plan-container">
                                                            <div class="txt-container"><?php echo strtoupper($_smarty_tpl->tpl_vars['LANG']->value['featuredProduct']); ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php } ?>
...
-order-button" <?php if ($_smarty_tpl->tpl_vars['product']->value['hasRecommendations']) { ?> data-has-recommendations="1" <?php } ?>>
                    ...
                    <?php
                    $sd = $_smarty_tpl->tpl_vars['productGroup']->value['features'];
                    if (is_countable($sd) && count($sd) > 0) { ?>
