<div class="card">
	<div class="card-body">
		...
		<form method="post" action="domainforwarding.php?action=managedomfwd" onclick="return confirmDelete();">
			<input type="hidden" name="id" value="{$id}"/>
			<input type="hidden" name="domain" value="{$domain}"/>
			<input type="hidden" name="disablefwd" value="true"/>
			<p><input type="submit" value="{$LANG.rcdns_deletebutton} {$LANG.rcdns_domainfwdmanagement}" class="btn btn-danger btn-lg"/></p>
		</form>
