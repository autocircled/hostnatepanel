...
<script language="javascript" type="text/javascript">
	...
	function confirmBulkDelete(){literal}{{/literal}return confirm("{$LANG.rcdom_bulkdeletewarndesc}");{literal}}{/literal}
</script>
				...
				{if $candelete neq "false"}
					...
					<form method="post" action="domainmanagement.php?action=changedomaincontacts#tabDelete">
						<table class="table table-bordered table-hover">
							<tr>
								<td class="textcenter">
									<h3>{$LANG.rcdom_domcontactdeletebulktitle}</h3>
									<p>
										{$LANG.rcdom_domcontactdeletebulkdesc}
										<br /><br />
										<sup><strong>{$LANG.rcdom_noteword}</strong> {$LANG.rcdom_domcontactdeletebulknote}</sup>
									</p>
									<input type="hidden" name="request" value="bulkdeleteunused"/>
									<input type="hidden" name="productkey" value="{$contactproductkey}"/>
									<input type="hidden" name="irtprule" value="{$irtprule}"/>
									<input type="hidden" name="tab" value="deletecontact"/>
									<input type="hidden" name="domainid" value="{$domainid}"/>
									<input type="hidden" name="domain" value="{$domain}"/>
									<p align="center"><input class="btn btn-danger" type="submit" value="{$LANG.rcdom_bulkdeletebutton}" onclick="return confirmBulkDelete();"/></p>
								</td>
							</tr>
						</table>
					</form>
