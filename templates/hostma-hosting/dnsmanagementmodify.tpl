		...
		<form method="post" action="dnsmanagement.php?action=managednszonemodify">
			...
			<table class="table table-bordered table-hover">
				...
				<tr>
					...
					<td>
						...
						<div class="input-group mb-3">
							<input type="text" class="form-control" value="{$hostrecord}" name="host">
				...
				<tr>
					...
					<td>
						<input name="ttl" class="form-control col-2" type="text" value="{if $ttlrecord}{$ttlrecord}{/if}" size="4"/>
				...
				<tr>
					...
					<td>
						<input name="priority" class="form-control col-2" type="text" value="{if $priorityrecord}{$priorityrecord}{/if}" size="4"/>
					</td>
				</tr>
				{/if}
				{if $recordtype eq "SRV"}
				...
				<tr>
					...
					<td>
						<input name="weight" class="form-control col-2" type="text" value="{if $weightrecord}{$weightrecord}{/if}" size="4"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input name="port" class="form-control col-2" type="text" value="{if $portrecord}{$portrecord}{/if}" size="4"/>
					</td>
				</tr>
				{/if}
				{if $recordtype eq "SOA"}
				<tr>
					...
					<td>
						<input name="soaexpire" class="form-control col-2" type="text" value="{if $soaexpire}{$soaexpire}{/if}" size="4"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input name="soaretry" class="form-control col-2" type="text" value="{if $soaretry}{$soaretry}{/if}" size="4"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input name="soarefresh" class="form-control col-2" type="text" value="{if $soarefresh}{$soarefresh}{/if}" size="4"/>
					</td>
				</tr>
				{/if}
				<tr>
